...
echo $workspace_file
echo "android_sdk_repository(name = \"androidsdk\", path = \"${android_sdk_path}\")"
echo "android_ndk_repository(name = \"androidndk\", api_level=21, path = \"${android_ndk_path}/android-ndk-${ndk_version}\")"
